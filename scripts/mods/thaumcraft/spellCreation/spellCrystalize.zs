...
zenClass SpellCrystalize extends FocusEffect {
    ...
    zenConstructor() {
      ...
      this.crystalizeBlocks = {
        'aer'     : (<item:quark:crystal>.asBlock() as Block).getStateFromMeta(7),
        'aqua'    : (<item:quark:crystal>.asBlock() as Block).getStateFromMeta(7),
        'ignis'   : (<item:quark:crystal>.asBlock() as Block).getStateFromMeta(7),
        'ordo'    : (<item:quark:crystal>.asBlock() as Block).getStateFromMeta(7),
        'perditio': (<item:quark:crystal>.asBlock() as Block).getStateFromMeta(7),
        'terra'   : (<item:quark:crystal>.asBlock() as Block).getStateFromMeta(7),
        'vitium'  : (<item:quark:crystal>.asBlock() as Block).getStateFromMeta(7),
