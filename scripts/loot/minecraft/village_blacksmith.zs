...
scripts.lib.loot.addLootToPool(location, 'main', {
  ...
  <tconstruct:axe_head>.withTag({Material: "black_quartz"})       : [5, 0, 1, 1],
  <tconstruct:axe_head>.withTag({Material: "carbon_fiber"})       : [10, 0, 1, 1],
  <tconstruct:binding>.withTag({Material: "alubrass"})            : [10, 0, 1, 1],
  <tconstruct:binding>.withTag({Material: "invar"})               : [5, 0, 1, 1],
  <tconstruct:binding>.withTag({Material: "paper"})               : [10, 0, 1, 1],
  <tconstruct:cross_guard>.withTag({Material: "amber"})           : [5, 0, 1, 1],
  <tconstruct:kama_head>.withTag({Material: "construction_alloy"}): [10, 0, 1, 1],
  <tconstruct:kama_head>.withTag({Material: "fluix"})             : [5, 0, 1, 1],
  <tconstruct:pick_head>.withTag({Material: "certus_quartz"})     : [5, 0, 1, 1],
  <tconstruct:pick_head>.withTag({Material: "copper"})            : [10, 0, 1, 1],
  <tconstruct:sharpening_kit>.withTag({Material: "dragonbone"})   : [5, 0, 1, 1],
  <tconstruct:sharpening_kit>.withTag({Material: "essence_metal"}): [5, 0, 1, 1],
  <tconstruct:sharpening_kit>.withTag({Material: "flint"})        : [10, 0, 1, 1],
  <tconstruct:shovel_head>.withTag({Material: "aluminium"})       : [10, 0, 1, 1],
  <tconstruct:shovel_head>.withTag({Material: "chocolate"})       : [5, 0, 1, 1],
  <tconstruct:sword_blade>.withTag({Material: "bone"})            : [10, 0, 1, 1],
  <tconstruct:sword_blade>.withTag({Material: "iron"})            : [10, 0, 1, 1],
  <tconstruct:sword_blade>.withTag({Material: "silver"})          : [5, 0, 1, 1],
  ...
  <tconstruct:tool_rod>.withTag({Material: "treatedwood"})        : [5, 0, 1, 1],
  <tconstruct:wide_guard>.withTag({Material: "bloodbone"})        : [10, 0, 1, 1],
  <tconstruct:wide_guard>.withTag({Material: "emerald_plustic"})  : [5, 0, 1, 1],
