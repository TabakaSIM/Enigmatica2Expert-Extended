...
static magicConsumables as int[][IItemStack] = { // Total weight = 90
  <botania:blacklotus:1>  : [2,  2,  1, 1],
  <botania:blacklotus>    : [8,  0,  1, 2],
  <botania:overgrowthseed>: [10, 10, 1, 2],
...
static magicComponents as int[][IItemStack] = { // Total weight = 110
  <botania:manaresource:1>         : [5,  5, 1, 2],
  <botania:manaresource:2>         : [5,  5, 1, 2],
  <endreborn:item_dragonite_seeds> : [2,  2, 1, 1],
  ...
  <thaumcraft:mechanism_complex>   : [3,  3, 1, 1],
  <thaumcraft:mechanism_simple>    : [10, 0, 1, 3],
  <thaumcraft:mind:1>              : [5,  5, 1, 1],
  <thaumcraft:mind>                : [4,  4, 1, 1],
  <thaumcraft:module:1>            : [4,  4, 1, 1],
  <thaumcraft:module>              : [5,  5, 1, 1],
  <thaumcraft:morphic_resonator>   : [10, 0, 1, 2],
  <thaumcraft:vis_resonator>       : [10, 0, 1, 2],
  <thaumicwonders:primordial_grain>: [2,  2, 1, 5],
};
...
static badFood as int[][IItemStack] = { // Total weight = 160
  ...
  <warptheory:item_something>     : [5,   5, 1, 2],
};

static goodFood as int[][IItemStack] = { // Total weight = 51
  <contenttweaker:dairy_pill>            : [3, 3, 1, 2],
  <contenttweaker:fruit_pill>            : [3, 3, 1, 2],
  <contenttweaker:grain_pill>            : [3, 3, 1, 2],
  <contenttweaker:protein_pill>          : [3, 3, 1, 2],
  <contenttweaker:vegetable_pill>        : [3, 3, 1, 2],
  <harvestcraft:chickencurryitem>        : [3, 3, 1, 2],
  <harvestcraft:chimichangaitem>         : [3, 3, 1, 2],
  <harvestcraft:delightedmealitem>       : [3, 3, 1, 2],
  <harvestcraft:deluxechickencurryitem>  : [3, 3, 1, 2],
  <harvestcraft:deluxenachoesitem>       : [3, 3, 1, 2],
  <harvestcraft:gourmetporkburgeritem>   : [3, 3, 1, 2],
  <harvestcraft:gourmetvenisonburgeritem>: [3, 3, 1, 2],
  <harvestcraft:hamandpineapplepizzaitem>: [3, 3, 1, 2],
  <harvestcraft:netherstartoastitem>     : [3, 3, 1, 2],
  <harvestcraft:ploughmanslunchitem>     : [3, 3, 1, 2],
  <harvestcraft:randomtacoitem>          : [3, 3, 1, 2],
  <harvestcraft:thankfuldinneritem>      : [3, 3, 1, 2],
};

static techComponents as int[][IItemStack] = { // Total weight = 405
  <forestry:oak_stick>             : [20, 0, 2, 6],
  <ic2:component_heat_vent>        : [5,  5, 1, 2],
  <ic2:crafting:1>                 : [50, 0, 1, 2],
  <ic2:crafting:2>                 : [20, 0, 1, 2],
  <ic2:crafting:6>                 : [20, 0, 1, 1],
  <ic2:crafting:7>                 : [20, 0, 1, 2],
  <ic2:heat_exchanger>             : [5,  5, 1, 2],
  <ic2:heat_vent>                  : [5,  5, 1, 2],
  <ic2:overclocked_heat_vent>      : [5,  5, 1, 2],
  ...
  <nuclearcraft:part:7>            : [5,  5, 1, 2],
  <nuclearcraft:part:8>            : [5,  5, 1, 2],
  <nuclearcraft:part:9>            : [5,  5, 1, 2],
  <opencomputers:card:2>           : [5,  5, 1, 1],
  <opencomputers:component:1>      : [5,  5, 1, 1],
  <opencomputers:component:8>      : [5,  5, 1, 1],
  <opencomputers:storage:3>        : [5,  5, 1, 1],
  <thermalfoundation:material:256> : [5,  5, 1, 3],
  <thermalfoundation:material:258> : [5,  5, 1, 3],
  <thermalfoundation:material:26>  : [5,  5, 1, 3],
  <thermalfoundation:material:291> : [5,  5, 1, 3],
};

static tinkersModifiers as int[][IItemStack] = { // Total weight = 57
  <actuallyadditions:item_crystal_empowered:2>: [1, 1, 1, 1],
  ...
  <tinkersaddons:modifier_item:4>             : [1, 1, 1, 1],
};

static upgrades as int[][IItemStack] = { // Total weight = 98
  <advgenerators:capacitor_kit_advanced>    : [1,  1, 1, 1],
  ...
  <mekanism:tierinstaller:1>                : [1,  1, 1, 1],
  <mekanism:tierinstaller>                  : [3,  3, 1, 1],
  <nuclearcraft:upgrade:1>                  : [3,  3, 1, 1],
  <nuclearcraft:upgrade>                    : [3,  3, 1, 1],
  ...
  <storagedrawers:upgrade_storage:2>        : [2,  2, 1, 1],
  <storagedrawers:upgrade_storage>          : [6,  0, 1, 1],
  <teslacorelib:energy_tier1>               : [4,  0, 1, 1],
  <teslacorelib:energy_tier2>               : [2,  2, 1, 1],
  <teslacorelib:speed_tier1>                : [4,  0, 1, 1],
  <teslacorelib:speed_tier2>                : [2,  2, 1, 1],
  <thermalexpansion:augment:128>            : [3,  1, 1, 1],
  <thermalfoundation:upgrade:1>             : [2,  2, 1, 1],
